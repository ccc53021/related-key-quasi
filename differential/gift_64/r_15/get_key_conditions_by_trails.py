...
# for example: basis = [[15, 0], [30, 1]], which means that tk1_15 = 0 and tk1_30 = 1
...
import differential_p_48 as differentials
routes = differentials.routes
print(len(routes))
diff = routes[0]
import quasidifferential_p_48 as quasidifferentials
